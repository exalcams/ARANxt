...
import { AppUsage, AppUsageView, MenuApp, Plant, Reason, RoleWithApp, SessionMaster, UserLoginHistory, UserNotification, UserPreference, UserView, UserWithRole, VendorUser } from "../Model/master";
